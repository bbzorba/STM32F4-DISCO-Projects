...
/* CAN IRQ handlers defined in bxcan.c — declared weak so the linker
   falls back to Default_Handler if bxcan.c is not linked. */
...
void (* const vector_table[])(void) = {
    ...
    CAN1_TX_IRQHandler,         // IRQ 19: CAN1_TX
    CAN1_RX0_IRQHandler,        // IRQ 20: CAN1_RX0
    CAN1_RX1_IRQHandler,        // IRQ 21: CAN1_RX1
    CAN1_SCE_IRQHandler,        // IRQ 22: CAN1_SCE
    ...
    CAN2_TX_IRQHandler,         // IRQ 63: CAN2_TX
    CAN2_RX0_IRQHandler,        // IRQ 64: CAN2_RX0
    CAN2_RX1_IRQHandler,        // IRQ 65: CAN2_RX1
    CAN2_SCE_IRQHandler,        // IRQ 66: CAN2_SCE
