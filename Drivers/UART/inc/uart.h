...
// MODER has 2 bits per pin at [2*n+1:2*n]
#define GPIOA_MODER_PIN9_MASK    ((uint32_t)0x000C0000)        // mask to clear PA9 mode bits (bits 19:18)
#define GPIOA_MODER_PIN10_MASK   ((uint32_t)0x00300000)        // mask to clear PA10 mode bits (bits 21:20)
...
#define GPIOA_MODER_PIN9_SET      ((uint32_t)0x00080000)        // set AF (10b) for PA9 (bits 19:18)
#define GPIOA_MODER_PIN10_SET     ((uint32_t)0x00200000)        // set AF (10b) for PA10 (bits 21:20)
...
#define GPIOA_AFRL_PIN3_MASK      ((uint32_t)0x0000F000)        // AF7 mask for PA3 (bits 15:12)
// AFRH pin 9 uses bits [7:4], pin 10 uses bits [11:8]
#define GPIOA_AFRH_PIN9_MASK      ((uint32_t)0x000000F0)        // AF7 mask for PA9 (bits 7:4)
#define GPIOA_AFRH_PIN10_MASK     ((uint32_t)0x00000F00)        // AF7 mask for PA10 (bits 11:8)
...
#define GPIOA_AFRH_PIN9_SET       ((uint32_t)0x00000070)        // AF7 for PA9 (bits 7:4)
#define GPIOA_AFRH_PIN10_SET      ((uint32_t)0x00000700)        // AF7 for PA10 (bits 11:8)
...
// AFRH for PB10/PB11 (USART3): nibble indices 2 and 3
#define GPIOB_AFRH_PIN10_MASK     ((uint32_t)0x00000F00)        // AF7 mask for PB10 (bits 11:8)
#define GPIOB_AFRH_PIN11_MASK     ((uint32_t)0x0000F000)        // AF7 mask for PB11 (bits 15:12)
...
#define GPIOB_AFRH_PIN10_SET      ((uint32_t)0x00000700)        // AF7 for PB10 (bits 11:8)
#define GPIOB_AFRH_PIN11_SET      ((uint32_t)0x00007000)        // AF7 for PB11 (bits 15:12)
...
#define GPIOC_MODER_PIN10_MASK   ((uint32_t)0x00300000)        // mask to clear PC10 mode bits (bits 21:20)
#define GPIOC_MODER_PIN11_MASK   ((uint32_t)0x00C00000)        // mask to clear PC11 mode bits (bits 23:22)
#define GPIOC_MODER_PIN12_MASK   ((uint32_t)0x03000000)        // mask to clear PC12 mode bits (bits 25:24)
...
#define GPIOC_MODER_PIN10_SET     ((uint32_t)0x00200000)        // set AF for PC10 (bits 21:20)
#define GPIOC_MODER_PIN11_SET     ((uint32_t)0x00800000)        // set AF for PC11 (bits 23:22)
#define GPIOC_MODER_PIN12_SET     ((uint32_t)0x02000000)        // set AF for PC12 (bits 25:24)
...
#define GPIOC_AFRH_PIN10_MASK     ((uint32_t)0x00000F00)        // AF8 mask for PC10 (bits 11:8)
#define GPIOC_AFRH_PIN11_MASK     ((uint32_t)0x0000F000)        // AF8 mask for PC11 (bits 15:12)
#define GPIOC_AFRH_PIN12_MASK     ((uint32_t)0x000F0000)        // AF8 mask for PC12 (bits 19:16)
...
#define GPIOC_AFRH_PIN10_SET      ((uint32_t)0x00000800)        // AF8 for PC10 (bits 11:8)
#define GPIOC_AFRH_PIN11_SET      ((uint32_t)0x00008000)        // AF8 for PC11 (bits 15:12)
#define GPIOC_AFRH_PIN12_SET      ((uint32_t)0x00080000)        // AF8 for PC12 (bits 19:16)
