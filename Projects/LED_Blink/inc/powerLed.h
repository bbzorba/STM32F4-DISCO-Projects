...
uint32_t PowerLED_computeEfficiency(USART_HandleType *usart, const LED_Type * const pled);
void PowerLED_runDiagnostics(USART_HandleType *usart, const LED_Type * const pled);
